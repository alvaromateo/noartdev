...
`}
        ...
        The core has three different configuration files, located in the structure specified above.

        ### core.properties

        The core.properties file is used to configure simple core properties. It is going to be 
        simple, as Solr defaults are good for a blog search feature. 
        The only things needed are the name of the blog and the configuration set that 
        I will use for the index of the core.

        <CodeBlock language='yaml'>
{`name=posts
configSet=blog-configset
`}
        </CodeBlock>
