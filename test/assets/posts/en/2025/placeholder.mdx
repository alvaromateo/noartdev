<div>
  <section id='post-intro'>
    # Post of 2025
    <PublishDate year={2025} month={9} day={20}/>
    <Tags list={['random', 'test', 'parrot', 'animal']}/>
    <Summary>
      In this <Link href='http://google.com'>post</Link> I will explain my journey to create an accordion or dropdown
      (un)folding animation that makes the contents grow in height. The framework used is NextJs with Typescript 
